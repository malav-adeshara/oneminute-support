...
const Navbar = async () => {
    ...
    return (
        <nav className='fixed top-0 inset-x-0 z-50 transition-all duration-300 backdrop-blur-xl border-white/5 bg-[#050509]/50'>
            <div className='max-w-6xl mx-auto px-6 h-16 flex items-center justify-between'>
                ...
                <div className='hidden md:flex items-center gap-8 text-sm font-light text-zinc-400'>
                    ...
                    <Link href="#prising" className='hover:text-white transition-colors'>
                        Prising
                    </Link>
                </div>
